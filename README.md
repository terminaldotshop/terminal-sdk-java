...
[![Maven Central](https://img.shields.io/maven-central/v/shop.terminal.api/terminal-java)](https://central.sonatype.com/artifact/shop.terminal.api/terminal-java/2.4.0)
[![javadoc](https://javadoc.io/badge2/shop.terminal.api/terminal-java/2.4.0/javadoc.svg)](https://javadoc.io/doc/shop.terminal.api/terminal-java/2.4.0)
...
The REST API documentation can be found on [terminal.shop](https://terminal.shop/docs). Javadocs are available on [javadoc.io](https://javadoc.io/doc/shop.terminal.api/terminal-java/2.4.0).
...
```kotlin
implementation("shop.terminal.api:terminal-java:2.4.0")
```
