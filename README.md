...
[![Maven Central](https://img.shields.io/maven-central/v/shop.terminal.api/terminal-java)](https://central.sonatype.com/artifact/shop.terminal.api/terminal-java/1.0.1)
[![javadoc](https://javadoc.io/badge2/shop.terminal.api/terminal-java/1.0.1/javadoc.svg)](https://javadoc.io/doc/shop.terminal.api/terminal-java/1.0.1)
...
```kotlin
implementation("shop.terminal.api:terminal-java:1.0.1")
```
