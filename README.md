...
[![Maven Central](https://img.shields.io/maven-central/v/shop.terminal.api/terminal-java)](https://central.sonatype.com/artifact/shop.terminal.api/terminal-java/1.5.0)
[![javadoc](https://javadoc.io/badge2/shop.terminal.api/terminal-java/1.5.0/javadoc.svg)](https://javadoc.io/doc/shop.terminal.api/terminal-java/1.5.0)
...
```kotlin
implementation("shop.terminal.api:terminal-java:1.5.0")
```
