...
[![Maven Central](https://img.shields.io/maven-central/v/shop.terminal.api/terminal-java)](https://central.sonatype.com/artifact/shop.terminal.api/terminal-java/1.6.1)
[![javadoc](https://javadoc.io/badge2/shop.terminal.api/terminal-java/1.6.1/javadoc.svg)](https://javadoc.io/doc/shop.terminal.api/terminal-java/1.6.1)
...
The REST API documentation can be found on [terminal.shop](https://terminal.shop/docs). Javadocs are also available on [javadoc.io](https://javadoc.io/doc/shop.terminal.api/terminal-java/1.6.0).
...
```kotlin
implementation("shop.terminal.api:terminal-java:1.6.1")
```
