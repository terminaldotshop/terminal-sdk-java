...
[![Maven Central](https://img.shields.io/maven-central/v/shop.terminal.api/terminal-java)](https://central.sonatype.com/artifact/shop.terminal.api/terminal-java/0.1.0-alpha.2)
...
```kotlin
implementation("shop.terminal.api:terminal-java:0.1.0-alpha.2")
```
