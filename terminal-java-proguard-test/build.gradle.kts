...
dependencies {
    testImplementation(project(":terminal-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../terminal-java-core/src/main/resources/META-INF/proguard/terminal-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../terminal-java-core/src/main/resources/META-INF/proguard/terminal-java-core.pro",
