...
class SubscriptionTest {
    ...
    fun createSubscription() {
      ...
      assertThat(subscription.next()).contains("2025-02-01T19:36:19.000Z")
      assertThat(subscription.schedule()).contains(Subscription.Schedule.ofWeekly(Subscription.Schedule.Weekly.builder()
          .interval(3L)
          .type(Subscription.Schedule.Weekly.Type.WEEKLY)
          .build()))
    }
