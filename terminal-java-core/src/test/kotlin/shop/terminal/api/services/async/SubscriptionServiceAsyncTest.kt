...
class SubscriptionServiceAsyncTest {
    ...
    fun list() {
      ...
      val subscriptionFuture = subscriptionServiceAsync.list()
    ...
    fun delete() {
      ...
      val subscriptionFuture = subscriptionServiceAsync.delete(SubscriptionDeleteParams.builder()
          .id("sub_XXXXXXXXXXXXXXXXXXXXXXXXX")
          .build())
    ...
    fun get() {
      ...
      val subscriptionFuture = subscriptionServiceAsync.get(SubscriptionGetParams.builder()
          .id("sub_XXXXXXXXXXXXXXXXXXXXXXXXX")
          .build())
