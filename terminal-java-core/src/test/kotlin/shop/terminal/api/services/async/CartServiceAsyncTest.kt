...
class CartServiceAsyncTest {
    ...
    fun convert() {
      ...
      val responseFuture = cartServiceAsync.convert(CartConvertParams.builder()
    ...
    fun redeemGiftCard() {
      ...
      val responseFuture = cartServiceAsync.redeemGiftCard(CartRedeemGiftCardParams.builder()
    ...
    fun setAddress() {
      ...
      val responseFuture = cartServiceAsync.setAddress(CartSetAddressParams.builder()
    ...
    fun setCard() {
      ...
      val responseFuture = cartServiceAsync.setCard(CartSetCardParams.builder()
    ...
    fun setItem() {
      ...
      val responseFuture = cartServiceAsync.setItem(CartSetItemParams.builder()
