...
class UserTest {
    ...
    fun createUser() {
        ...
        assertThat(user.email()).contains("john@example.com")
        assertThat(user.fingerprint()).contains("183ded44-24d0-480e-9908-c022eff8d111")
        assertThat(user.name()).contains("John Doe")
