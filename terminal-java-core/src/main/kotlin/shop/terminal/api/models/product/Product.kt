...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun timeHidden(): Optional<String> = timeHidden.getOptional("timeHidden")
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (timeHidden.asKnown().isPresent) 1 else 0)
    ...
    class Subscription @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmStatic fun of(value: String) = Subscription(JsonField.of(value))
        }
