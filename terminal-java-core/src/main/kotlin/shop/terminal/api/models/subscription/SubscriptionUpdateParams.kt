...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun schedule(): Optional<Schedule> = body.schedule()
    ...
    private constructor(
        ...
        fun fixed(): Optional<JsonValue> = Optional.ofNullable(fixed)

        fun weekly(): Optional<Weekly> = Optional.ofNullable(weekly)
         ...
         * import shop.terminal.api.core.JsonValue;
         *
         * Optional<String> result = schedule.accept(new Schedule.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitFixed(JsonValue fixed) {
        ...
        companion object {
            ...
            @JvmStatic fun ofFixed() = Schedule(fixed = JsonValue.from(mapOf("type" to "fixed")))

            @JvmStatic fun ofWeekly(weekly: Weekly) = Schedule(weekly = weekly)
        }
