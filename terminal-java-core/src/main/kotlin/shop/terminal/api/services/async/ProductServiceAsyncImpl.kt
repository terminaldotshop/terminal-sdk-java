...
class ProductServiceAsyncImpl internal constructor(
    ...
    override fun list(params: ProductListParams, requestOptions: RequestOptions): CompletableFuture<ProductListResponse> =
        // get /product
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun get(params: ProductGetParams, requestOptions: RequestOptions): CompletableFuture<ProductGetResponse> =
        // get /product/{id}
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: ProductListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProductListResponse>> {
        ...
        override fun get(params: ProductGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProductGetResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
