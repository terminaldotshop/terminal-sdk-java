...
class SubscriptionServiceAsyncImpl internal constructor(
    ...
    override fun list(params: SubscriptionListParams, requestOptions: RequestOptions): CompletableFuture<SubscriptionListResponse> =
        // get /subscription
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: SubscriptionDeleteParams, requestOptions: RequestOptions): CompletableFuture<SubscriptionDeleteResponse> =
        // delete /subscription/{id}
        withRawResponse().delete(params, requestOptions).thenApply { it.parse() }

    override fun get(params: SubscriptionGetParams, requestOptions: RequestOptions): CompletableFuture<SubscriptionGetResponse> =
        // get /subscription/{id}
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: SubscriptionListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SubscriptionListResponse>> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: SubscriptionDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SubscriptionDeleteResponse>> {
          val request = HttpRequest.builder()
        ...
        override fun get(params: SubscriptionGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SubscriptionGetResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("subscription", params.getPathParam(0))
            .build()
