...
interface AppServiceAsync {
    ...
    /** @see [create] */
    fun create(params: AppCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AppCreateResponse>

    /** List the current user's registered apps. */
    fun list(): CompletableFuture<AppListResponse> = list(AppListParams.none())

    /** @see [list] */
    fun list(params: AppListParams = AppListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AppListResponse>
    ...
    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<AppListResponse> = list(AppListParams.none(), requestOptions)
    ...
    /** @see [delete] */
    fun delete(params: AppDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AppDeleteResponse>
    ...
    /** @see [get] */
    fun get(params: AppGetParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AppGetResponse>
    ...
    interface WithRawResponse {
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: AppCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AppCreateResponse>>
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: AppListParams = AppListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AppListResponse>>

        /** @see [list] */
        @MustBeClosed
        fun list(params: AppListParams = AppListParams.none()): CompletableFuture<HttpResponseFor<AppListResponse>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AppListResponse>> = list(AppListParams.none(), requestOptions)
        ...
        /** @see [delete] */
        @MustBeClosed
        fun delete(params: AppDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AppDeleteResponse>>
        ...
        /** @see [get] */
        @MustBeClosed
        fun get(params: AppGetParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AppGetResponse>>
    }
}
