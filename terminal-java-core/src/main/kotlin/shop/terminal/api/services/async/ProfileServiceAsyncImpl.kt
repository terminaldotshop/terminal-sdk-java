...
class ProfileServiceAsyncImpl internal constructor(
    ...
    override fun update(params: ProfileUpdateParams, requestOptions: RequestOptions): CompletableFuture<ProfileUpdateResponse> =
        // put /profile
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun me(params: ProfileMeParams, requestOptions: RequestOptions): CompletableFuture<ProfileMeResponse> =
        // get /profile
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun update(params: ProfileUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProfileUpdateResponse>> {
        ...
        override fun me(params: ProfileMeParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProfileMeResponse>> {
          val request = HttpRequest.builder()
